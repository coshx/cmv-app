...
define([
    ...
    'dojo/text!./Search/templates/Search.html', // need to add this template!
    'dojo/i18n!./Search/nls/resource',  // need to add this resource.js

    'xstyle/css!./Search/css/Search.css' // need to edit this
], function (declare, _WidgetBase, _TemplatedMixin, a11yclick, lang, on, domClass, domStyle, Search, MenuItem, SimpleMarkerSymbol, Graphic, InfoTemplate, GraphicsLayer, template, i18n) {
